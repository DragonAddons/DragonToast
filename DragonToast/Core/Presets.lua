...
ns.Presets.order = {
    "default", "minimal", "classic", "dark", "elegant",
    "parchment", "compact", "neon", "frost", "stealth",
}
...
ns.Presets.data = {
    ...
    elegant = {
        ...
        backgroundColor   = { r = 0.08, g = 0.06, b = 0.12 },
        backgroundTexture = "Solid",
        qualityBorder     = true,
        qualityGlow       = true,
        iconSize          = 36,
    ...
    parchment = {
        ...
        backgroundColor   = { r = 0.18, g = 0.14, b = 0.08 },
        backgroundTexture = "Solid",
        qualityBorder     = true,
        qualityGlow       = false,
        iconSize          = 38,
    ...
    compact = {
        ...
        backgroundColor   = { r = 0.03, g = 0.03, b = 0.03 },
        backgroundTexture = "Solid",
        qualityBorder     = true,
        qualityGlow       = false,
        iconSize          = 28,
    ...
    neon = {
        ...
        backgroundAlpha   = 0.85,
        backgroundColor   = { r = 0.02, g = 0.02, b = 0.06 },
        backgroundTexture = "Solid",
        qualityBorder     = true,
        qualityGlow       = true,
        iconSize          = 36,
    ...
    frost = {
        ...
        backgroundColor   = { r = 0.04, g = 0.08, b = 0.14 },
        backgroundTexture = "Solid",
        qualityBorder     = true,
        qualityGlow       = true,
        iconSize          = 36,
